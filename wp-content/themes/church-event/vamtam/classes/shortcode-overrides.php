...
class WpvShortcodeOverrides {
	...
	public static function wpv_splash_screen() {
		...
		$logo_style = 'background:url("' . esc_attr( wpv_get_option( 'splash-screen-logo' ) ) . '") center center no-repeat';

		echo '<div class="wpv-splash-screen">
			<div class="wpv-splash-screen-logo" style="' . esc_attr( $logo_style ) . '"></div>
		</div>';
	}
